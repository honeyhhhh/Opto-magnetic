...
/* Handle deprecated NDLIB Calls */
#if _MSC_FULL_VER >= 140050320
#define NDI_DEPRECATED(_Text)	__declspec(deprecated(_Text))
#else
#define NDI_DEPRECATED(_Text)	__declspec(deprecated)
#endif
