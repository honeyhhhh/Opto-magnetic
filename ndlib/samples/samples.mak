...
#       run vcvars32 to setup variables if needed before running nmake
#
# For Watcom C++
...
!IF "$(COMP)" == "BC5"
CC      = Bcc32
CPFLAGS = -DWIN32 -D_CONSOLE -DPLATFORM_X86
CFLAGS  = -c -w -v- -Od -I$(INCLUDE_DIR)
!ELSE IF "$(COMP)" == "MSVC"
CC      = cl
CPFLAGS = -DWIN32 -DSTRICT -D_CONSOLE -DPLATFORM_X86
CFLAGS  = -c -DNDEBUG -MD -Gd -Od -W3 -Zp -I$(INCLUDE_DIR)
!ELSE IF "$(COMP)" == "WC11"
CC      = wcc386
CPFLAGS = -DWIN32 -D_CONSOLE -DPLATFORM_X86
...
certus_sample20.exe : certus_sample20.obj $(certus_OBJS) $(OT_OBJS) $(SLEEP)
    $(LINKER) $(LINKFLAGS) certus_sample20.obj $(certus_OBJS) $(OT_OBJS) $(LIBS)
