...
void main( int argc, char *argv[] )
{
    ...
    if( OdauSetupCollection(
            ...
            90000.0,                /* Frequency to scan channels at. */
            1,                      /* Stream mode for the data buffers. */
            2.0,                    /* Number of seconds of data to collect. */
    ...
    /*
     * Convert the raw data in the file 'R#001.S14' and write the
    ...
    if( FileConvert( "O1#001.S14", "V1#001.S14", ANALOG_RAW ) )
    {
        goto ERROR_EXIT;
    } /* if */
